 ...
 * Any temperature-controlled indication -> "Reefer 53'"; everything else
 * (ambient / dry / unknown) -> "Dry Van 53'".
 */
export function toEquipmentType(mode) {
  const m = String(mode ?? "").toLowerCase();
  const reefer = /reefer|refriger|frozen|freeze|chill|cold|temp|perish|fresh/;
